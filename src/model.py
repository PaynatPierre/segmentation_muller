...
from loss_and_metrics import IoU_metric, ponderation_IoULoss

def micro_unet(pretrained_weights = PRETRAINED_WEIGHTS,input_size = (TRAINING_IMAGE_SIZE_CROP[0],TRAINING_IMAGE_SIZE_CROP[1],TRAINING_IMAGE_SIZE_CROP[2])):
